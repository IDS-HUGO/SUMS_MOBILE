...
class _MemberCard extends ConsumerWidget {
  ...
  const _MemberCard({
    ...
    required this.roles,
    required this.sexoOpts,
    required this.edoCivilOpts,
    required this.lenguaOpts,
    required this.escolaridadOpts,
    required this.ingresoOpts,
    required this.embarazoOpts,
    required this.tamizajeOpts,
                      ...
                      children: [
                        if (form.sexo == 'Femenino') ...[
                          ...
                          SizedBox(
                            width: w,
                            child: _select(
                              label: 'Tamizaje cérvico-uterino',
                              icon: Icons.health_and_safety_outlined,
                              value: form.tamizajeCervico,
                              options: tamizajeOpts,
                              onChanged: (v) {
                          ...
                          if (form.tamizajeCervico == 'Sí')
                            SizedBox(
                              ...
                              child: SumsTextField(
                                ...
                                icon: Icons.event_outlined,
                                readOnly: true,
                                validator: (v) => _validateTamizajeDate(
                                  v,
                                  form.fechaNacimiento.text,
                                ),
                                onTap: () => _selectDateSimple(
                                  context,
                                  form.fechaCervico,
                                  form.fechaNacimiento.text,
                                  onChanged,
                        ...
                        SizedBox(
                          width: w,
                          child: _select(
                            label: 'Frecuencia de uso de servicios',
                            icon: Icons.schedule_outlined,
                            value: form.frecuenciaSalud,
                            options: freqSaludOpts,
                            onChanged: (v) {
                              form.frecuenciaSalud = v;
                              onChanged();
                            },
                            validator: requiredText,
                          ),
  ...
  Widget _chipGroup(
    ...
    builder: (state) => InputDecorator(
      decoration: InputDecoration(labelText: '', errorText: state.errorText),
      child: Wrap(
        spacing: 8,
        runSpacing: 8,
        children: [
