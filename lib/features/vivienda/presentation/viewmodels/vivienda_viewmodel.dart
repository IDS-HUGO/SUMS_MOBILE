...
class ViviendaViewModel extends ChangeNotifier {
  ...
  void setParedes(String? value) {
    paredes = value;
    notifyListeners();
  }

  void setPiso(String? value) {
    piso = value;
    notifyListeners();
  }

  void setCocina(String? value) {
    cocina = value;
    notifyListeners();
  }

  void setExcretas(String? value) {
    excretas = value;
    notifyListeners();
  }

  void setAguaEntubada(bool value) {
    aguaEntubada = value;
    notifyListeners();
  }

  void setEnergiaElect(bool value) {
    energiaElect = value;
    notifyListeners();
  }

  void setCoccionLena(bool value) {
    coccionLena = value;
    notifyListeners();
  }

  void setAlcantarillado(bool value) {
    alcantarillado = value;
    notifyListeners();
  }

  void setFosaSeptica(bool value) {
    fosaSeptica = value;
    notifyListeners();
  }

  void setPerrosGatos(bool value) {
    perrosGatos = value;
    notifyListeners();
  }

  void setAnimVacunas(bool value) {
    animVacunas = value;
    notifyListeners();
  }

  void setEsterilizados(bool value) {
    esterilizados = value;
    notifyListeners();
  }
  ...
  Map<String, dynamic> toPayload() {
    final parts = <String>[];
    if (techo == 'Otros (especifique)' && techoOtro.text.trim().isNotEmpty)
      parts.add('Techo: ${techoOtro.text.trim()}');
    if (paredes == 'Otros (especifique)' && paredesOtro.text.trim().isNotEmpty)
      parts.add('Paredes: ${paredesOtro.text.trim()}');
